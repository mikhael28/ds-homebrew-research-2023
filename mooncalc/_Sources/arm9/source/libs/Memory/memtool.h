...
extern TMM MM_Temp,MM_System,MM_SystemAfter,MM_Skin,MM_DLLImage,MM_DLLSound,MM_DLLDPG,MM_SKKOSK,MM_Process;
...
#define safemalloc(pMM,size) __safemalloc__(pMM,__MODULE__,__LINE__,__FUNCTION__,size)
#define safemalloc_chkmem(pMM,size) __safemalloc_chkmem__(pMM,__MODULE__,__LINE__,__FUNCTION__,size)
