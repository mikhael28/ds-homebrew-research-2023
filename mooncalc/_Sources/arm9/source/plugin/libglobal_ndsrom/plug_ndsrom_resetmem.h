...
__attribute__ ((section (".rebootloader"))) asm void reset_MemCopy32CPU(const void *src,void *dst,u32 len)
...
__attribute__ ((section (".rebootloader"))) asm void reset_MemSet32CPU(u32 v,void *dst,u32 len)
