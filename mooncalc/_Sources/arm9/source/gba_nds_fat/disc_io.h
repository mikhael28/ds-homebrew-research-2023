...
#define BlockReadLimitSectorsCount (32) // normal read.
#define BlockWriteLimitSectorsCount (32) // normal write.
...
typedef bool (* FN_MEDIUM_WRITESECTORS)(u32 sector, u8 numSecs, const void* buffer) ;
